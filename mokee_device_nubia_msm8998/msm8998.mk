...
$(call inherit-product, device/nubia/msm8998-common/hidl/hidl.mk)
...
# Volte config files
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/volte/mbn_sw.txt:system/etc/modem_config/mbn_sw.txt \
    $(LOCAL_PATH)/configs/volte/oem_sw.txt:system/etc/modem_config/oem_sw.txt \
    $(LOCAL_PATH)/configs/volte/mbn_sw.dig:system/etc/modem_config/mbn_sw.dig \
    $(LOCAL_PATH)/configs/volte/volte_op/mcfg_sw.mbn:system/etc/modem_config/volte_op/mcfg_sw.mbn
...
# Init
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,${LOCAL_PATH}/rootdir/init/vendor,$(TARGET_COPY_OUT_VENDOR))
...
# Telephony
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/telephony/config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/telephony/config.xml
...
# Ramdisk
#PRODUCT_COPY_FILES += \
#    $(LOCAL_PATH)/rootdir/init.nubia.rc:root/init.nubia.rc \
#    $(LOCAL_PATH)/rootdir/init.nubia.touch.lcd.rc:root/init.nubia.touch.lcd.rc
